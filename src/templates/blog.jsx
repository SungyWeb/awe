...
const indentMap = {
  'H1': 0,'H2': '0.5em','H3': '1em','H4': '1.5em','H5': '2em','H6': '2.5em'
}
  ...
  return (
    <Layout>
      <>
        ...
        <Anchor style={{position: 'fixed', left: anchorLeft, top: 100, width: 150}}>
          {navs.map(v => <Anchor.Link  key={v.id} href={'#'+v.id} title={<Text tagName={v.tag} text={v.text} />}></Anchor.Link>)}
        </Anchor>
